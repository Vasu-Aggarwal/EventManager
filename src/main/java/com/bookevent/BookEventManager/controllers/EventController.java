...
public class EventController {
    ...
    public ResponseEntity<EventDto> createEvent(@RequestBody EventDto eventDto) throws ParseException {
        EventDto newEvent = this.eventService.createEvent(eventDto);
